...
do
    ...
    do 
        ...
        do
            ...
            for lr in  5e-5 1e-5 5e-4 1e-4 5e-6 1e-6 #5e-3 1e-3
            do 
                gpu_device="2"
                ...
                if [ "$USE_SLURM" == "1" ]; then
                    ...
                    export LD_PRELOAD=$LD_PRELOAD:/home/bingxing2/ailab/scx6mh7/.conda/envs/dnalm_v2/lib/python3.8/site-packages/scikit_learn.libs/libgomp-d22c30c5.so.1.0.0
                    export LD_PRELOAD=$LD_PRELOAD:/home/bingxing2/apps/compilers/gcc/12.2.0/lib64/libstdc++.so.6
                ...
                batch_size=32
                data=''
                data_file_train=train_new.csv; data_file_val=val.csv; data_file_test=test,HSPE1,SNHG6,WHAMMP2
                echo ${MODEL_PATH}
