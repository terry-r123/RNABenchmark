...
export DATA_PATH=/mnt/data/oss_beijing/multi-omics/RNA/downstream/CRISPROffTarget/K562/
export OUTPUT_PATH=./outputs/ft/rna-all/CRISPROffTarget/rna/baseline/rnalm-6mer-ape/scratch
export STAGE=None
